...
public class compiladoresLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "PA", "PC", "CA", "CC", "LA", "LC", "LETRA", "DIGITO", "WS", 
			"COMILLA", "COMILLASIMPLE", "PYC", "IGUAL", "MAS", "MENOS", "MULTIPLICACION", 
			"DIVISION", "MODULO", "INCREMENTAR", "DECREMENTAR", "COMA", "MAYOR", 
			"MENOR", "MAYORIGUAL", "MENORIGUAL", "IGUALIGUAL", "DIFERENTE", "AND", 
			"OR", "NOT", "WHILE", "FOR", "IF", "ELSE", "RETURN", "PRINTF", "DT", 
			"OPERADOR", "LOGICO", "NUMERO", "ID"
		};
	}
